<?php
    ...
    function selectionQuery($connexion, $id){
        $sql= ($id===null)?"SELECT * FROM loginpt":"SELECT * FROM loginpt WHERE id=$id";
    ...
    function insertQuery($connexion){
        ...
        $sql= "INSERT INTO loginept (signInTitle, signInParagraph, signInEmail, signInPw, signInPw2, signInBtn, signInInfTittle, signInInfParagraph, signInInfBtn, signUpTitle, signUpEmail, signUpPw, signUpBtn, signUpInfTittle, signUpInfParagraph, signUpInfBtn) VALUES ('$signInTitle','$signInParagraph','$signInEmail','$signInPw','$signInPw2','$signInBtn',' $signInInfTittle','$signInInfParagraph','$signInInfBtn','$signUpTitle','$signUpEmail','$signUpPw',' $signUpBtn',' $signUpInfTittle','$signUpInfParagraph','$signUpInfBtn')";
    ...
    function deleteQuery($connexion, $id){
        ...
        $sql= "DELETE FROM loginpt WHERE id =$id";
        $resultado =$connexion->query($sql);
